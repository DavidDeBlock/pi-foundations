...
const Store = (() => {
  ...
  const seed = () => {
    ...
    return {
      ...
      sources: [
        ...
        { id: 's_isabelle', name: 'Isabelle private', type: 'bank',  ownerId: 'u_isabelle', active: true },
        { id: 's_joint',    name: 'Joint account',    type: 'bank',  ownerId: null,        active: true },
        { id: 's_cash',     name: 'Cash',             type: 'cash',  ownerId: null,        active: true },
        { id: 's_savings',  name: 'Savings',          type: 'savings', ownerId: null,      active: true },
      ],
      categories: [
  ...
  return {
    ...
    // Sources
    addSource(state, s) { const src = { id: uid(), active: true, ...s }; state.sources.push(src); save(state); return src; },
