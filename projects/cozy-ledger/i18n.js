...
const Strings = {
  nl: {
    ...
    'dashboard.card.balance.pos':     'Gespaard in periode',
    ...
    'dashboard.recent.empty.title':   'Geen transacties in deze periode',
    'dashboard.recent.empty.msg':     'Druk op + om je eerste toe te voegen.',
    'dashboard.top.title':            'Topcategorieën in periode',
